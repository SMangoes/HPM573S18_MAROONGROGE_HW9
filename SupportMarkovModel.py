...
def print_outcomes(simOutput, therapy_name):
    ...
    number_of_strokes_text = F.format_estimate_interval(
        estimate=simOutput.get_sumStat_number_of_Strokes().get_mean(),
        interval=simOutput.get_sumStat_number_of_Strokes().get_t_CI(alpha=Settings.ALPHA),
        deci=2)
