...
class PatientStateMonitor:
    ...
    def __init__(self, parameters):
        ...
        self._strokecount = 0        # number of stroke counter
        self._ifhadStroke = False       #boolean for if they had a stroke
    ...
    def get_number_of_strokes(self):
        """ returns the number of strokes patient had """
        # return time to AIDS  only if the patient has developed AIDS
        if self._ifhadStroke:
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        self._list_of_number_of_strokes = []        # patients' numbers of strokes
        ...
        for patient in simulated_cohort.get_patients():
            ...
            number_of_strokes= patient.get_number_of_strokes()
            if not (number_of_strokes is None):
                self._list_of_number_of_strokes.append(number_of_strokes)
        ...
        self._sumState_numberofStrokes = StatCls.SummaryStat('Number of strokes', self._list_of_number_of_strokes)
    ...
    def get_number_of_strokes(self):
        return self._list_of_number_of_strokes
    ...
    def get_sumStat_number_of_Strokes(self):
        return self._sumState_numberofStrokes
